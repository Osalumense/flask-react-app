          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/3">
              <div className="h-full rounded-xl shadow-cla-blue bg-gradient-to-r from-indigo-50 to-blue-50 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="leading-relaxed mb-5">Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Donec rutrum congue leo eget malesuada. Quisque velit nisi, pretium ut lacinia in, elementum id enim. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem.</p>
                  <div className="flex items-center flex-wrap ">
                    <button className="px-4 py-3 bg-indigo-700 text-white hover:-translate-y-1 transition-all duration-500 hover:bg-gray-200 hover:text-indigo-800 font-semibold rounded-2xl">Learn more</button>
            ...
            <div className="p-4 md:w-1/3">
                <div className="h-full rounded-xl shadow-cla-violate bg-gradient-to-r from-pink-50 to-red-50 overflow-hidden">
                  ...
                  <div className="p-6">
                    <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY-2</h2>
                    <h1 className="title-font text-lg font-medium text-gray-600 mb-3">The Catalyzer</h1>
                    <p className="leading-relaxed mb-5">Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Donec rutrum congue leo eget malesuada. Quisque velit nisi, pretium ut lacinia in, elementum id enim. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem.</p>
                    <div className="flex items-center flex-wrap ">
                      <button className="px-4 py-3 bg-indigo-700 text-white hover:-translate-y-1 transition-all duration-500 hover:bg-gray-200 hover:text-indigo-800 font-semibold rounded-2xl">Learn more</button>
              ...
              <div className="p-4 md:w-1/3">
                <div className="h-full rounded-xl shadow-cla-pink bg-gradient-to-r from-fuchsia-50 to-pink-50 overflow-hidden">
                  ...
                  <div className="p-6">
                    <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY-3</h2>
                    <h1 className="title-font text-lg font-medium text-gray-600 mb-3">The Catalyzer</h1>
                    <p className="leading-relaxed mb-5">Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Donec rutrum congue leo eget malesuada. Quisque velit nisi, pretium ut lacinia in, elementum id enim. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem.</p>
                    <div className="flex items-center flex-wrap ">
                      <button className="px-4 py-3 bg-indigo-700 text-white hover:-translate-y-1 transition-all duration-500 hover:bg-gray-200 hover:text-indigo-800 font-semibold rounded-2xl">Learn more</button>
